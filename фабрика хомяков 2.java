...
class HamsterFactory {
    ...
    HashSet<Hamster> fabrika=new HashSet<>();// нужна структура данных, в которой можно хранить только уникальных хомяков
    ...
    private void executePrint() {
        ...
        for (Hamster homyak:fabrika)
        {
            System.out.println("Хомяк '"+homyak.name+"'");
        }
    ...
    private void executeCreate(String name)
    {
        ...
        if(fabrika.add(novyiHomyak)==false)
        {
